						...
						{lastUpdatedDevice ? (
							...
							>
								<DeviceFrame size="lg" portrait={isPortrait}>
									<Image
										src={`/api/bitmap/${lastUpdatedDevice.screen}.${lastUpdatedDevice.image_format === "png" ? "png" : "bmp"}?width=${deviceWidth}&height=${deviceHeight}${lastUpdatedDevice.palette_id ? `&palette=${encodeURIComponent(lastUpdatedDevice.palette_id)}&dither=${lastUpdatedDevice.dithering_method ?? "floyd-steinberg"}` : ""}`}
